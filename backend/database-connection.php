...
$db       = $configs["DB"];     // Name of the database
$port     = $configs["PORT"];                           // Port is usually 3306 in Hostgator
$charset  = 'utf8mb4';                       // UTF-8 encoding using 4 bytes of data per char

$username = $configs["USERNAME"];     // Enter YOUR cPanel username and user here
$password = $configs["PASSWORD"];           // Enter YOUR user password here
